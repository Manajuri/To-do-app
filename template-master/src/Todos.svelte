...
import Todoitem from './TodoItem.svelte';
    ...
    function clearCompleted(){
        todos = todos.filter(toso => !todo.completed);
    }

    function handDeleteTodo(event){
...
<div class="container">
    <img src={'/img/fashion.png'} alt="Seaf">
    ...
    {#each filteredTodos as todo}
        ...
        <div class="todo-item">
            <TodoItem {...todo} on:deleteTodo={handDeleteTodo} on:toggleComplete={handleToggleComplete} />
        </div>
    {/each}
